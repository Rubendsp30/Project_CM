package com.example.project_cm.Fragments.VacinesDirectory;
...
public class VaccineAdapter extends RecyclerView.Adapter<VaccineAdapter.VaccineViewHolder> {
    ...
    public void onBindViewHolder(@NonNull VaccineViewHolder holder, int position) {
        ...
        if (daysLeft <= 5) {
            ...
            holder.textViewDaysLeft.setTextColor(ContextCompat.getColor(holder.itemView.getContext(), R.color.red));
        } else if (daysLeft <= 10) {
            // Entre 6 e 10 dias: laranja
            holder.textViewDaysLeft.setTextColor(ContextCompat.getColor(holder.itemView.getContext(), R.color.orange));
        } else {
            // Mais de 10 dias: verde
            holder.textViewDaysLeft.setTextColor(ContextCompat.getColor(holder.itemView.getContext(), R.color.green));
        }
